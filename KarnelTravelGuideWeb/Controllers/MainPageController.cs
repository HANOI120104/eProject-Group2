...
namespace KarnelTravelGuideWeb.Controllers
{
    public class MainPageController : Controller
    {
        ...
        public IActionResult Search(string query, string country, string type, int? cityId, decimal? maxPrice, List<int> quality, string sort)
        {
            ...
            {
                hotelsQuery = hotelsQuery.Where(h => quality.Contains(h.QualityRating));
                resortsQuery = resortsQuery.Where(r => quality.Contains(r.QualityRating));
                restaurantsQuery = restaurantsQuery.Where(r => quality.Contains(r.QualityRating));
            }
            ...
            var searchResults = new SearchResultsVM
            {
                ...
                Cities = cities,
                TotalResults = hotels.Count + resorts.Count + tourists.Count + restaurants.Count
            };
            ...
            if (!string.IsNullOrEmpty(type))
            {
                ...
                {
                    case "hotel":
                        searchResults.Resorts.Clear();
                        searchResults.Tourists.Clear();
                        searchResults.Restaurants.Clear();
                        searchResults.TotalResults = searchResults.Hotels.Count;
                        break;
                    case "resort":
                        searchResults.Hotels.Clear();
                        searchResults.Tourists.Clear();
                        searchResults.Restaurants.Clear();
                        searchResults.TotalResults = searchResults.Resorts.Count;
                        break;
                    case "touristspot":
                        searchResults.Hotels.Clear();
                        searchResults.Resorts.Clear();
                        searchResults.Restaurants.Clear();
                        searchResults.TotalResults = searchResults.Tourists.Count;
                        break;
                    case "restaurant":
                        searchResults.Hotels.Clear();
                        searchResults.Resorts.Clear();
                        searchResults.Tourists.Clear();
                        searchResults.TotalResults = searchResults.Restaurants.Count;
                        break;
                }
            }
        ...
        public IActionResult Search(string? query)
        {
            ...
            if (!string.IsNullOrEmpty(query))
            {
                ...
                citiesQuery = citiesQuery.Where(r => r.Name.Contains(query));
            }
        ...
        public IActionResult AddContact(ContactVM model)
        {
            ...
            return View("Contact", new List<ContactVM> { model });
        }
